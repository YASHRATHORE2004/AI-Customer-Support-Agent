...
from ai_customer_agent.models import WorkflowStep
...
class TestCustomerServiceAgent:
    ...
    @patch("ai_customer_agent.agent.OpenAI")
    ...
    @patch("ai_customer_agent.agent.CustomerServiceAgent._call_openai_api")
